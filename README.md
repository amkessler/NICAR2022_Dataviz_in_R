...
the following packages, which can be installed by running this in the console:
...
To then load the repo for this class session, run this line from the console within RStudio:
